<div>
    ...
    <div class="w-full">
        ...
        <div class="mt-4 flex flex-col items-center justify-center gap-2 px-2 w-full">
    ...
    @endif
        ...
        <div wire:show="showExamen" x-transition.opacity.duration.500ms
            ...
            <div wire:show="showExamen" x-transition:enter="ease-out duration-300"
                        ...
                        <div class="mt-2 space-y-4">
                            <div>
                                <label for="nombre" class="block text-sm font-medium text-gray-700">Nombre de la
                                    Nombre</label>
                                <input type="text" wire:model="nombre" placeholder="Nombre del examen"
                            ...
                            <div>
                                ...
                                <input type="text" wire:model="precio" placeholder="Precio"
                                    class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 @error('precio') !border-red-600 @enderror" />
                ...
                <div class=" px-4 py-3 flex flex-col justify-center sm:flex-row gap-2">
                    <button type="button" wire:click="modalExamenClose"
                        class="inline-flex w-full justify-center rounded-md bg-red-500 px-3 py-2 text-sm font-semibold text-white hover:bg-red-400 sm:ml-3 sm:w-auto">
                        Cancelar
                    </button>
