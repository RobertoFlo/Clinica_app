<div>
    ...
    <div class="w-full h-full border border-gray-300  rounded grid md:grid-cols-2 grid-cols-1 gap-2 bg-white">
        <div>
            <div class="m-5">
            ...
            <h2 class="text-2xl text-center mt-2">Formulario</h3>
                <div class="p-4">
                    ...
                    <button wire:click="LimpiarPaciente"
                        class="mt-2 inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded shadow-sm text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                        Limpiar
                    </button>
                ...
                <hr>
                <form action="savecita" class="p-4 grid grid-cols-1 gap-4">
                    ...
                    <div class="flex justify-end">
                        <button type="button" wire:click="agendarCita"
                            ...
                            {{$modeedicion?'Actualizar':'Agendar'}} Cita
                        </button>
                    </div>
                </form>
        </div>
